...
class robot_email_model extends CI_Model {

    public function __construct() {
        parent::__construct();
    }

    public function send_email_recovery_pass($em, $arr, $name) {

        $this->email->from(EMAIL_POSTMASTER, NAME_SITE);
        $this->email->to($em);
        $this->email->subject(lang("index_email_msg_forgot_pass_title"));
        $texto = '
    <!doctype html>
           ...
           <a href = "' . base_url('exec-renew-pass') . "?put=" . base64_encode($em . ":" . $arr['id'] . ":" . $name) . '" style = "color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp;
           ' . lang("index_email_msg_forgot_pass_buttom") . ' &nbsp;
           </a>
           </div>
           ...
           <table class = "table-row-fixed" width = "450" bgcolor = "#FFFFFF" style = "table-layout: fixed; background-color: #ffffff;" cellspacing = "0" cellpadding = "0" border = "0"><tbody>
           <tr><td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: left; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;" valign="top">
                 ' . lang("index_email_msg_forgot_pass_footer") . '
               </td></tr>

           <tr><td class = "table-row-fixed-td" style = "font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 1px; padding-right: 1px;" valign = "top" align = "left">
           ...
           <a href = "javascript: void(0)" style = "color: #428bca; text-decoration: none; background-color: transparent;">' . NAME_SITE . ' &copy;
           ' . date("Y") . '</a>
           <br>
           </td></tr></tbody></table>
           </td></tr></tbody></table>
    ...
    public function send_email_renew_pass($em, $new_p) {

        $this->email->from(EMAIL_POSTMASTER, NAME_SITE);
        $this->email->to($em);
        $this->email->subject(lang("index_email_msg_forgot_renew_title"));
        $texto = '
    <!doctype html>
            <html xmlns="http://www.w3.org/1999/xhtml">
           <head>
           ...
           <table class = "table-col" align = "left" width = "378" cellspacing = "0" cellpadding = "0" border = "0" style = "table-layout: fixed;"><tbody><tr><td class = "table-col-td" width = "378" style = "font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign = "top" align = "left">
             <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="center"><img src="' . base_url(LOGO_NAV) . '" width="100px"></td></tr></tbody></table>
           <table class = "header-row" width = "378" cellspacing = "0" cellpadding = "0" border = "0" style = "table-layout: fixed;"><tbody><tr><td class = "header-row-td" width = "378" style = "font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign = "top" align = "left">' . lang("index_email_msg_forgot_renew_title") . '</td></tr></tbody></table>
           <div style = "font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
           <b style = "color: #777777;">' . lang("index_email_msg_forgot_renew_content") . '</b>
           <br>
           </div>
           </td></tr></tbody></table>
           </td></tr></tbody></table>
    ...
    public function send_email_new($em) {

        $this->email->from(EMAIL_POSTMASTER, NAME_SITE);
        $this->email->to($em);
        $this->email->subject(lang("index_email_msg_change_email_title"));
        $texto = '
    <!doctype html>
            <html xmlns="http://www.w3.org/1999/xhtml">
           <head>
           ...
           <table class = "table-col" align = "left" width = "378" cellspacing = "0" cellpadding = "0" border = "0" style = "table-layout: fixed;"><tbody><tr><td class = "table-col-td" width = "378" style = "font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign = "top" align = "left">
             <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="center"><img src="' . base_url(LOGO_NAV) . '" width="100px"></td></tr></tbody></table>
           <table class = "header-row" width = "378" cellspacing = "0" cellpadding = "0" border = "0" style = "table-layout: fixed;"><tbody><tr><td class = "header-row-td" width = "378" style = "font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign = "top" align = "left">' . lang("index_email_msg_change_email_title") . '</td></tr></tbody></table>
           <div style = "font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
           <b style = "color: #777777;">' . lang("index_email_msg_change_email") . '</b>
           <br>
           </div>
           </td></tr></tbody></table>
           </td></tr></tbody></table>
